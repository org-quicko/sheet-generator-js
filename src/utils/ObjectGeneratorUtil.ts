...
import { MixinGeneratorUtil } from './MixinGeneratorUtil.js';
import { SheetGeneratorUtil } from './SheetGeneratorUtil.js';
import { WorkbookGeneratorUtil } from './WorkbookGeneratorUtil.js';
...
export class ObjectGeneratorUtil {
    ...
    public static generate(schema: JsonSchema, outputDir: string): void {
        ...
        MixinGeneratorUtil.generate(mixinsDir, classNames);
        ...
        try {
            ...
            for (const { folderPath, importPath } of subfolders) {
                ...
                try {
                    ...
                    const files = FileUtil.getAllFiles(resolvedFolderPath)
                        .filter(file => {
                    ...
                    for (const file of files) {
                        ...
                        const exportStatement = `export * from '${fullImport}.js';`;
